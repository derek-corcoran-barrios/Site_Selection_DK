...
ggpairs(OnlyPoints, columns = c(6:10,16:18), ggplot2::aes(colour=Selection_time, alpha = 0.3)) 
```
...
* Add biodiversity layer for distances
* Include new protected areas as a focused area
